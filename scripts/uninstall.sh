...
rm -f /usr/local/sbin/makia-update /usr/local/sbin/makia-backup /usr/local/sbin/makia-uninstall /usr/local/sbin/makia-doctor /usr/local/sbin/makia-uat-smoke /usr/local/sbin/makia-restore /usr/local/sbin/makia-reset-admin /usr/local/sbin/makia-upgrade
